...
Works with **Conductor** for remediation programmes; OKF knowledge lives **in the repo**, not only under `.cursor/`.
...
| `.cursor/knowledge/` | Fallback only — avoid for user-facing project docs |
...
| `CONTEXT.md` | `.cursor/context/product.md` or repo `CONTEXT.md` + OKF overview concepts |
